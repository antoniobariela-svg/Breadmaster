...
const CARDS = [
  ...
  { id: 'ai', emoji: '🤖', titleId: 'BreadMaster AI', titleEn: 'BreadMaster AI', subId: 'Tanya ahli roti AI — analisis, saran & diagnosa', subEn: 'Ask AI bread expert — analysis & diagnosis', tag: 'AI', gradient: ['#1a0a3e', '#3B1F0A'], featured: true, aiCard: true },
];
